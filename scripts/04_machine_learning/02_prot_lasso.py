...
#lookup
label_lookup = cedar.set_index("epitope_id")[
    ["label", "mt_seq", "wt_seq", "mt_length", "best_hla"]
].to_dict("index")
...
#save 
pd.DataFrame(all_results).to_csv("lasso_ProtTrans_all_datasets.csv", index=False)

with open("roc_ProtTrans_all_datasets.pkl", "wb") as f:
